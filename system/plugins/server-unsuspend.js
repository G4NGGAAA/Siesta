const { unsuspendServer, unsuspendAllServers } = require('../lib/server.js');

let handler = async (m, { kzm, args }) => {
    ...
    try {
        if (unsuspendAll) {
            ...
            return kzm.sendMessage(m.chat, { text: reportText }, { quoted: m });
        }
        const srv = args[0];
