...
case 'sc': case 'script': {
 let teks = 'Lu mau ngab? 😂\n\n> Mau scnya? chat owner'
 let owner = '6283115376765' // ganti sama no owner lu
 let directLink = `https://wa.me/${owner}?text=Bang%20gw%20mau%20beli%20scnya` 
 let thumb = 'https://files.catbox.moe/wo31nt.jpeg' 
 ...
 title: '*SIESTA*',
 subtitle: 'Script bot Siesta',
 hasMediaAttachment: true,
 ...(await prepareWAMessageMedia(
 { image: { url: thumb } },
 { upload: kzm.waUploadToServer }
 ))
 }),
 ...
 display_text: 'Chat Glitch kids🤭',
 url: directLink,
 merchant_url: directLink
 })
 }
 ]
 })
 ...
 await kzm.relayMessage(m.chat, msg.message, { messageId: msg.key.id });
}
break
